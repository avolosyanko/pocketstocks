...
const Overview = () => {
    return (
      <View>
        ...
        <View style={{ backgroundColor: 'white', borderRadius: 25, margin: 18, marginTop: 15, marginBottom: 0, height: 580 }}>
        ...
        <View style={{ height: 1, marginTop: 10, backgroundColor: '#F0F0F0' }}></View>
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity style={{ flexDirection: 'row', borderWidth: 1, borderColor: 'lightgray', borderRadius: 30, marginTop: 10, marginBottom: 10, marginLeft: 15, padding: 12, paddingLeft: 32, width: 160 }}>
            <Image
                source={require('./assets/images/actions.png')}
                style={{ width: 18, height: 18, marginLeft: 5 }}/>
            <Text style={{ color: 'gray', marginLeft: 5, fontSize: 13, fontFamily: 'OpenSans_Regular' }}>Actions</Text>
          </TouchableOpacity>

          <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#101010', borderRadius: 30, marginTop: 10, marginBottom: 10, marginLeft: 10, padding: 12, paddingLeft: 32, width: 160 }}>
            <Image
                source={require('./assets/images/messaging-circle.png')}
                style={{ width: 18, height: 18, marginLeft: 0 }}/>
            <Text style={{ color: 'white', marginLeft: 5, fontSize: 13, fontFamily: 'OpenSans_Regular' }}>Comments</Text>
          </TouchableOpacity>
        </View>
        </View>
      </View>
